...
impl ChartStats {
    ...
    pub fn mini_log(&self) -> String {
        format!(
            ...
            self.num_hangs.0,
            self.num_crashes.0,
            self.fuzz.get(fuzz_type::FuzzType::ExploreFuzz.index()).num_conds.0,
            self.fuzz.get(fuzz_type::FuzzType::ExploitFuzz.index()).num_conds.0,
            self.fuzz.get(fuzz_type::FuzzType::CmpFnFuzz.index()).num_conds.0,
            self.fuzz.get(fuzz_type::FuzzType::LenFuzz.index()).num_conds.0,
            self.fuzz.get(fuzz_type::FuzzType::AFLFuzz.index()).num_conds.0,
            self.fuzz.get(fuzz_type::FuzzType::OtherFuzz.index()).num_conds.0,
            self.fuzz.get(fuzz_type::FuzzType::ExploreFuzz.index()).num_exec.0,
            self.fuzz.get(fuzz_type::FuzzType::ExploitFuzz.index()).num_exec.0,
            self.fuzz.get(fuzz_type::FuzzType::CmpFnFuzz.index()).num_exec.0,
            self.fuzz.get(fuzz_type::FuzzType::LenFuzz.index()).num_exec.0,
            self.fuzz.get(fuzz_type::FuzzType::AFLFuzz.index()).num_exec.0,
            self.fuzz.get(fuzz_type::FuzzType::OtherFuzz.index()).num_exec.0,
            self.fuzz.get(fuzz_type::FuzzType::ExploreFuzz.index()).num_inputs.0,
            self.fuzz.get(fuzz_type::FuzzType::ExploitFuzz.index()).num_inputs.0,
            self.fuzz.get(fuzz_type::FuzzType::CmpFnFuzz.index()).num_inputs.0,
            self.fuzz.get(fuzz_type::FuzzType::LenFuzz.index()).num_inputs.0,
            self.fuzz.get(fuzz_type::FuzzType::AFLFuzz.index()).num_inputs.0,
            self.fuzz.get(fuzz_type::FuzzType::OtherFuzz.index()).num_inputs.0,
        )
    }
